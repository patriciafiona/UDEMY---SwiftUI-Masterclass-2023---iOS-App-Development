      ...
      VStack(alignment: .center, spacing: 0) {
        ...
        Form {
          ...
          Section(header: Text("Choose the app icon")) {
              Menu(content: {
              Picker(selection: $iconSettings.currentIndex, label: Text("")) {
                  ...
                  HStack {
                    ...
                    Spacer()
                      ...
                      Image(uiImage: UIImage(named: self.iconSettings.iconNames[self.iconSettings.currentIndex] ?? "Blue") ?? UIImage())
                          .renderingMode(.original)
                          .resizable()
                          .scaledToFit()
                      ...
                      Text(self.iconSettings.iconNames[self.iconSettings.currentIndex] ?? "Blue")
          ...
          Section(header: Text("About the application")) {
            ...
            FormRowStaticView(icon: "keyboard", firstText: "Developer", secondText: "Patricia Fiona")
